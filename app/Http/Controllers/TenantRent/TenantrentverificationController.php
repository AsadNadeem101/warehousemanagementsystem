...
class TenantrentverificationController extends Controller
{
    /**
     ...
     */
    public function index(TenantRentVerificationDataTable $dataTable)
    {
        return $dataTable->render('tenantrentverification.index');
    }
